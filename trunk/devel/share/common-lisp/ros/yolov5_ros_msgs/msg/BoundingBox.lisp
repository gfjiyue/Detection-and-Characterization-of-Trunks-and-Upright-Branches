...
(cl:defmethod depth-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_ros_msgs-msg:depth-val is deprecated.  Use yolov5_ros_msgs-msg:depth instead.")
  (depth m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBox>)))
  ...
  "d7fc1cf19228aec2a9f2ed9c7e5d70e1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBox)))
  "Returns md5sum for a message object of type 'BoundingBox"
  "d7fc1cf19228aec2a9f2ed9c7e5d70e1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int16 num~%string Class~%float32 depth~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int16 num~%string Class~%float32 depth~%~%~%"))
