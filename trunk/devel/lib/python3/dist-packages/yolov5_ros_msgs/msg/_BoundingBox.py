...
class BoundingBox(genpy.Message):
  _md5sum = "d7fc1cf19228aec2a9f2ed9c7e5d70e1"
...
float32 depth
"""
  __slots__ = ['probability','xmin','ymin','xmax','ymax','num','Class','depth']
  _slot_types = ['float64','int64','int64','int64','int64','int16','string','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       probability,xmin,ymin,xmax,ymax,num,Class,depth
